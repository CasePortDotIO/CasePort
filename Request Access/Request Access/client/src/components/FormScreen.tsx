        ...
        {needsManualAdvance && (
          <div className="flex items-center justify-end mt-4 flex-shrink-0">
            <motion.button
              ...
              onClick={isContactScreen ? onSubmit : onNext}
              disabled={isButtonDisabled}
              className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-[14px] font-semibold transition-all duration-250"
              style={{
