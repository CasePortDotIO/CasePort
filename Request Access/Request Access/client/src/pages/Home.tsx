...
import { HardStopScreen } from '@/components/HardStopScreen';
import { SoftFailModal } from '@/components/SoftFailModal';
...
export default function Home() {
  ...
  // Auto-collapse hero on short viewports (< 700px) so the form panel has maximum height
  const isShortViewport = typeof window !== 'undefined' && window.innerHeight < 700;
  const [heroExpanded, setHeroExpanded] = useState(!isShortViewport);
  ...
  return (
    <div
      className="min-h-screen sm:h-screen sm:overflow-hidden flex flex-col relative"
      style={{
        background: '#0A0E17',
