# CasePort.io Brand System — North Star

## Core Identity
- **CasePort is the Apple of legal lead generation** — engineered precision, not marketing fluff
- **Brand Voice:** Dan Lok meets Apple — direct, authoritative, zero fluff, high-status
- Never beg. Never oversell. State facts. Let the system speak for itself.
...
| Primary Text | #F1F3F5 | Headings, primary content |
...
- **No centered layouts** — prefer asymmetric/sidebar/grid structures
...
### Buttons
- **Primary CTA:** Linear gradient (135deg, #06B6D4, #8B5CF6), white text, 48px height, 28px horizontal padding, border-radius 12px
...
- **NO bouncing, spinning, NO parallax**
...
**REMEMBER:** Every design decision must reinforce that CasePort is engineered, disciplined, and controlled — not flashy or desperate. The system should speak for itself through clarity, precision, and institutional credibility.
