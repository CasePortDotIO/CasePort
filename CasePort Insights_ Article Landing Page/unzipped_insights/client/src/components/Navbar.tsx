    ...
    >
      <nav className="container flex items-center justify-between h-16 lg:h-[72px]">
        ...
        <div className="hidden md:flex items-center gap-10">
          <a
            href="https://www.caseport.io/for-law-firms"
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            href="/request-access"
            className="text-[13px] font-medium text-cp-text-secondary hover:text-cp-cyan transition-colors"
          >
            Request Access
          </a>
          <a
      ...
      {mobileOpen && (
        <div className="md:hidden bg-[#0A0E17]/95 backdrop-blur-xl border-t border-white/[0.06]">
          <div className="container py-6 flex flex-col gap-4">
            ...
            <a
              href="/request-access"
              className="text-[15px] font-medium text-cp-cyan hover:text-cp-cyan/80 transition-colors py-2"
            >
              Request Access
            </a>
