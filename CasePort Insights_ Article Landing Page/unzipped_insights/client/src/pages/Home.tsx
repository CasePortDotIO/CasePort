  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#030608] text-white antialiased scroll-smooth">
      ...
      <div className="sr-only" role="region" aria-label="About CasePort">
        ...
        <p>Personal injury lead costs vary significantly by market and case type. High-intent auto accident leads typically range from $150 to $1,500 per lead. CasePort's pricing is discussed during the review process and varies based on market, case type, and volume tier. The average auto accident settlement ranges from $36,000 to $500,000, making qualified lead acquisition a high-ROI investment for PI firms.</p>
        <h2>What is a case acquisition system?</h2>
        <p>A case acquisition system is an end-to-end infrastructure that goes beyond simple lead generation. It encompasses demand capture, qualification screening, intake control, opportunity routing, and recovery protocols. Unlike buying leads from a vendor, a case acquisition system gives law firms more control over the entire pipeline from initial search intent to signed retainer.</p>
        <h2>Best personal injury lead generation companies</h2>
        <p>The personal injury lead generation market includes companies like CasePort, eGenerationMarketing, LeadCounsel, FindLaw, Martindale-Avvo, and others. CasePort differentiates itself through its market-capped model (maximum 3 firms per metro area), 6-layer qualification framework, and structured recovery protocols. When evaluating lead generation providers, PI firms should consider lead exclusivity, qualification standards, market saturation, and transparent reporting.</p>
      </div>

      <main>
      {/* ─── ZONE 1: DEEP SPACE ─── Hero + Trust + Spotlight */}
      <div className="relative" style={{ background: "linear-gradient(180deg, #030608 0%, #040A10 20%, #060C14 45%, #050B12 65%, #040A10 80%, #030608 100%)" }}>
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <img src={HERO_BG} alt="" className="absolute inset-0 w-full h-[60%] object-cover opacity-20 mix-blend-screen" />
          ...
          <div className="absolute right-[-5%] top-[15%] h-[22rem] w-[22rem] rounded-full bg-violet-500/8 blur-[100px] animate-glow-pulse" style={{ animationDelay: '2s' }} />
        </div>
      ...
      <div className="relative" style={{ background: "linear-gradient(180deg, #030608 0%, #080804 8%, #0E0C04 20%, #120E06 35%, #100E06 50%, #0C0A04 65%, #080804 80%, #060A10 92%, #030608 100%)" }}>
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-1/2 top-[10%] h-[36rem] w-[36rem] -translate-x-1/2 rounded-full opacity-20" style={{ background: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, rgba(251,191,36,0.08) 40%, transparent 70%)" }} />
      ...
      <div className="relative" style={{ background: "linear-gradient(180deg, #030608 0%, #050C14 10%, #071018 25%, #091420 40%, #0B1624 50%, #091420 60%, #071018 75%, #050C14 90%, #030608 100%)" }}>
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="relative" style={{ background: "linear-gradient(180deg, #030608 0%, #080804 10%, #0E0C04 25%, #120E06 40%, #100E06 55%, #0C0A04 70%, #080804 85%, #030608 100%)" }}>
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-1/2 top-[20%] h-[36rem] w-[36rem] -translate-x-1/2 rounded-full opacity-25" style={{ background: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, rgba(251,191,36,0.08) 40%, transparent 70%)" }} />
        </div>
        <div className="relative">
          <ROISection />
          <LeadMagnetSection />
      ...
      <div className="relative" style={{ background: "linear-gradient(180deg, #030608 0%, #060A10 15%, #080E16 35%, #060A10 60%, #040810 80%, #030608 100%)" }}>
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-1/2 top-[30%] h-[40rem] w-[40rem] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-15" style={{ background: "radial-gradient(circle, rgba(0,212,255,0.15) 0%, rgba(124,92,255,0.08) 40%, transparent 65%)" }} />
        </div>
        <div className="relative">
      ...
      <div className="relative" style={{ background: "linear-gradient(180deg, #030608 0%, #050A10 15%, #070D16 30%, #0A1020 50%, #070D16 70%, #050A10 85%, #030608 100%)" }}>
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute right-[10%] top-[15%] h-[24rem] w-[24rem] rounded-full bg-cyan-500/4 blur-[120px]" />
          <div className="absolute left-1/2 top-[65%] h-[36rem] w-[36rem] -translate-x-1/2 rounded-full opacity-20" style={{ background: "radial-gradient(circle, rgba(0,212,255,0.12) 0%, rgba(124,92,255,0.06) 40%, transparent 65%)" }} />
        </div>
        <div className="relative">
          <FAQSection />
          <ScarcitySection />
...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#030608]/80 backdrop-blur-2xl transition-all duration-500">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 sm:px-6 lg:px-8">
        {/* Logo */}
        <a href="/" className="flex-shrink-0">
          <div className="text-[17px] font-extrabold tracking-[0.28em] text-white sm:text-lg">CASEPORT</div>
          <div className="system-label text-[#6B7280] mt-0.5 tracking-[0.22em]" style={{ fontSize: "0.5rem" }}>
        ...
        <nav className="hidden items-center gap-8 text-[13px] font-medium text-[#9CA3AF] lg:flex">
          <a href="#system" className="link-underline transition duration-200 hover:text-white">For Law Firms</a>
          <a href="https://www.caseport.io/markets" className="link-underline transition duration-200 hover:text-white">Markets</a>
          <a href="/insights" className="link-underline transition duration-200 hover:text-white">Insights</a>
          <a href="#intelligence" className="link-underline transition duration-200 hover:text-white">Intelligence</a>
          <a href="#injured" className="group flex items-center gap-1.5 transition duration-200 hover:text-white">
            Injured?
            ...
            {scrolled ? (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] text-amber-400/80 font-medium">17 founding slots left</span>
                </div>
                <button
                  className="rounded-full px-5 py-2 text-[12px] font-semibold text-black transition duration-200 hover:scale-[1.03]"
              ...
              >
                ...
                <a href="/request-access" className="rounded-full px-5 py-2 text-[13px] font-semibold text-white shadow-[0_0_24px_rgba(0,212,255,0.2)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_32px_rgba(0,212,255,0.35)] inline-block"
        ...
        <Sheet>
          <SheetTrigger asChild>
            <button className="lg:hidden rounded-xl border border-white/10 bg-white/[0.04] p-2.5" aria-label="Open menu">
              <Menu className="h-5 w-5 text-white" />
            </button>
          </SheetTrigger>
          <SheetContent side="right" className="bg-[#0A0E14] border-white/[0.06] w-[85%] sm:max-w-sm">
            <SheetHeader>
            ...
            <nav className="flex flex-col gap-1 px-4 mt-4">
              {[
                ...
                <a key={item.label} href={item.href} className="rounded-2xl px-4 py-3.5 text-[15px] font-medium text-[#D1D5DB] transition hover:bg-white/[0.04] hover:text-white">
                  {item.label}
                </a>
              ))}
              <div className="mt-6 pt-6 border-t border-white/[0.06]">
                <div className="text-[9px] uppercase tracking-[0.22em] text-[#6B7280] font-mono mb-3 text-center">For qualified firms only</div>
                <a href="/request-access" className="w-full rounded-full px-6 py-3.5 text-sm font-semibold text-white shadow-[0_0_24px_rgba(0,212,255,0.2)] block text-center" style={{ background: "linear-gradient(135deg, #00B4D8 0%, #5BB6C9 40%, #7C5CFF 100%)" }}>
                  Request Private Access
                </a>
              </div>
            </nav>
...
function HeroSection() {
  return (
    <section id="hero" aria-label="CasePort Case Acquisition System" className="relative pt-8 pb-3 sm:pt-10 sm:pb-4 lg:pt-12 lg:pb-5">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12">
          <motion.div variants={fadeUp} initial="hidden" animate="visible">
            <div className="inline-flex items-center gap-2.5 rounded-full border border-white/[0.08] bg-white/[0.03] px-4 py-1.5 mb-5">
              <div className="h-2 w-2 rounded-full bg-cyan-400 animate-pulse-dot" />
              <span className="system-label text-[#9CA3AF]">For Growth-Oriented Personal Injury Law Firms</span>
            </div>

            <h1 className="text-[2.5rem] sm:text-[3.25rem] lg:text-[3.75rem] xl:text-[4.25rem] font-bold leading-[0.95] tracking-[-0.04em]">
              Stop Buying Leads.
              <br />
              <span className="text-gradient-cyan">Start Controlling</span>
              <br />
              Case Flow.
            </h1>

            <p className="mt-5 max-w-xl text-[1.0625rem] text-[#B8C0CC] leading-[1.75]">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-4">
              <a href="/request-access"
                className="relative overflow-hidden rounded-full px-7 py-3 text-[14px] font-semibold text-white shadow-[0_0_30px_rgba(0,212,255,0.25)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(0,212,255,0.4)] inline-block"
                style={{ background: "linear-gradient(135deg, #00B4D8 0%, #5BB6C9 40%, #7C5CFF 100%)" }}
              >
              ...
              <a href="#how-it-works" className="group flex items-center gap-2 text-[14px] text-[#9CA3AF] font-medium transition hover:text-white">
                See How It Works
                <ArrowRight className="h-4 w-4 transition group-hover:translate-x-1" />
              </a>
            </div>

            <p className="mt-3 text-[12px] text-[#5A6270]">
          ...
          <motion.div variants={scaleIn} initial="hidden" animate="visible" transition={{ delay: 0.2 }}>
            <div className="relative animate-float">
              <div className="absolute inset-0 rounded-2xl blur-2xl opacity-50" style={{ background: "radial-gradient(circle at 50% 50%, rgba(0,212,255,0.08), transparent 60%)" }} />
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="rounded-full border border-white/[0.08] bg-white/[0.03] px-2.5 py-0.5">
                      <span className="system-label text-[#6B7280]" style={{ fontSize: '0.5625rem' }}>Private View</span>
                    </div>
                  </div>
                  <p className="text-[13px] font-medium text-white mb-3">A more controlled path from search intent to signed case opportunity</p>
                  <div className="grid grid-cols-3 gap-1.5">
                    {["Search Intent", "Demand Capture", "Qualification", "Routing", "Recovery", "Retained Value"].map((step, i) => (
                      <div key={step} className="rounded-lg border border-white/[0.06] bg-white/[0.02] px-2.5 py-2">
                  ...
                  <div className="mt-2.5 grid grid-cols-2 gap-1.5">
                    <div className="rounded-lg border border-cyan-400/10 bg-cyan-400/[0.03] px-2.5 py-2">
                      <span className="system-label text-cyan-400/60" style={{ fontSize: '0.5rem' }}>System Activity</span>
                      <div className="mt-1 space-y-0.5">
                        {["Protected market signal active", "Qualification layer engaged", "Review-first access in progress"].map((item) => (
                    ...
                    <div className="rounded-lg border border-violet-400/10 bg-violet-400/[0.03] px-2.5 py-2">
                      <span className="system-label text-violet-400/60" style={{ fontSize: '0.5rem' }}>Core Design Intent</span>
    ...
    <div className="py-4 sm:py-5">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-center gap-2.5">
          {["Market-Capped Access", "Review-First Onboarding", "Verified Standards", "Controlled Case Distribution"].map((item) => (
            <div key={item} className="rounded-full border border-white/[0.06] bg-white/[0.02] px-3.5 py-1.5">
              <span className="system-label text-[#7A8290]" style={{ fontSize: '0.6rem' }}>{item}</span>
            </div>
          ))}
        </div>
      </div>
...
function MarketIntelligenceSection() {
  ...
  return (
    <section ref={ref} id="intelligence" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-[1.75rem] sm:text-[2.25rem] lg:text-[2.75rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
            The Opportunity Is
            <span className="text-gradient-gold"> Massive</span>
          </h2>
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { value: 61.7, suffix: "B", prefix: "$", label: "U.S. Personal Injury Market", sub: "Annual market size" },
            { value: 6, suffix: "M+", prefix: "", label: "Auto Accidents Per Year", sub: "In the United States" },
            { value: 1500, suffix: "", prefix: "$", label: "Average Cost Per Lead", sub: "For high-intent PI leads" },
            { value: 50, suffix: "K–500K", prefix: "$", label: "Average Case Value", sub: "Auto accident settlements" },
          ].map((stat) => (
            <motion.div key={stat.label} variants={staggerItem} className="card-hover rounded-2xl border border-amber-500/12 bg-white/[0.02] p-6 text-center">
              <div className="text-[1.75rem] sm:text-[2rem] font-bold text-white font-mono tabular-nums">
                {isInView ? <AnimatedCounter target={stat.value} prefix={stat.prefix} suffix={stat.suffix} /> : `${stat.prefix}0${stat.suffix}`}
              </div>
...
function ProblemSection() {
  ...
  return (
    <section ref={ref} id="problem" aria-label="The Problem with Traditional Lead Generation" className="py-14 sm:py-18 lg:py-22">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-red-500/10 bg-red-500/[0.02] p-5">
                ...
                <div className="space-y-3">
                  {["Shared leads across 5+ firms", "No qualification before delivery", "No follow-up infrastructure", "No market protection"].map((item) => (
              ...
              <div className="rounded-2xl border border-cyan-400/12 bg-cyan-400/[0.02] p-5">
                ...
                <div className="space-y-3">
                  {["Market-capped exclusivity", "6-layer qualification screening", "Structured recovery protocols", "Transparent performance data"].map((item) => (
                    <div key={item} className="flex items-start gap-2.5">
  ...
  return (
    <section ref={ref} className="py-14 sm:py-18 lg:py-22">
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center mb-10">
          ...
          <h2 className="text-[1.5rem] sm:text-[2rem] lg:text-[2.5rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
            ...
            <br />
            <span className="text-gradient-cyan">to Controlled Acquisition</span>
          </h2>
        </motion.div>

        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
            <div className="system-label text-[#7A8290] mb-5">Before CasePort</div>
            <div className="space-y-4">
              {[
                { icon: <AlertTriangle className="h-4 w-4 text-amber-400/60" />, text: "Unpredictable lead quality month to month" },
                { icon: <Users className="h-4 w-4 text-amber-400/60" />, text: "Competing with 5+ firms for the same lead" },
                { icon: <Clock className="h-4 w-4 text-amber-400/60" />, text: "No visibility into what happens after delivery" },
                { icon: <TrendingUp className="h-4 w-4 text-amber-400/60" />, text: "Spending more but signing fewer cases" },
              ].map((item) => (
          ...
          <div className="rounded-2xl border border-cyan-400/10 bg-cyan-400/[0.02] p-6">
            ...
            <div className="space-y-4">
              {[
                { icon: <Filter className="h-4 w-4 text-cyan-400/70" />, text: "Every opportunity screened before it reaches you" },
                { icon: <Lock className="h-4 w-4 text-cyan-400/70" />, text: "Your market is protected — max 3 firms per metro" },
                { icon: <Eye className="h-4 w-4 text-cyan-400/70" />, text: "Full transparency into pipeline performance" },
                { icon: <Gauge className="h-4 w-4 text-cyan-400/70" />, text: "Compounding returns as the system matures" },
              ].map((item) => (
                <div key={item.text} className="flex items-start gap-3">
                  <div className="mt-0.5 flex-shrink-0">{item.icon}</div>
...
function BuyerRealitySection() {
  const { ref, isInView } = useScrollReveal(0.1);
  const realities = [
    { icon: <Clock className="h-5 w-5 text-amber-400/70" />, title: "Slow Response = Lost Cases", desc: "Research shows that responding within 5 minutes increases contact rates by 400%. Most firms take hours. Some take days. Every minute of delay is a case walking to your competitor." },
    { icon: <Users className="h-5 w-5 text-amber-400/70" />, title: "Shared Leads Destroy ROI", desc: "When 5 firms receive the same lead, your conversion rate drops to single digits. You are paying premium prices for a commodity product. The math does not work." },
    { icon: <Target className="h-5 w-5 text-amber-400/70" />, title: "No Qualification = Wasted Intake", desc: "Your highest-paid staff is spending time on leads that were never qualified. No injury verification. No liability screening. No case-fit assessment before delivery." },
    { icon: <RefreshCw className="h-5 w-5 text-amber-400/70" />, title: "No Recovery = Silent Revenue Loss", desc: "Up to 40% of viable cases are lost after first contact — not because the case was bad, but because follow-up broke down. Without recovery protocols, that revenue disappears silently." },
  ];

  return (
    <section ref={ref} className="py-14 sm:py-18 lg:py-22">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="max-w-3xl mb-10">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-2">
          {realities.map((item, i) => (
            <motion.div key={item.title} variants={staggerItem} className={`card-hover rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 ${i === 0 ? 'sm:row-span-1' : ''}`}>
...
function SystemProofSection() {
  const { ref, isInView } = useScrollReveal(0.1);
  return (
    <section ref={ref} id="system" aria-label="Inside the CasePort System" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="grid items-center gap-10 lg:grid-cols-[1fr_1fr] lg:gap-14">
          <motion.div variants={slideInLeft} initial="hidden" animate={isInView ? "visible" : "hidden"}>
            ...
            <h2 className="text-[1.75rem] sm:text-[2.25rem] lg:text-[2.75rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
              Not a Lead List.
              <br />
              <span className="text-gradient-cyan">A Case Acquisition Engine.</span>
            </h2>
            <p className="mt-4 text-[1.0625rem] text-[#B8C0CC] leading-[1.75]">
          ...
          <motion.div variants={slideInRight} initial="hidden" animate={isInView ? "visible" : "hidden"}>
            <div className="relative">
              <div className="absolute inset-0 rounded-2xl blur-2xl opacity-40" style={{ background: "radial-gradient(circle at 50% 50%, rgba(0,212,255,0.06), transparent 60%)" }} />
              <img src={SYSTEM_VIZ} alt="CasePort system architecture visualization" className="relative rounded-2xl border border-white/[0.06] w-full" />
            </div>
          </motion.div>
        </div>
      </div>
...
function CoreSystemSection() {
  const { ref, isInView } = useScrollReveal(0.1);
  const pillars = [
    { step: "01", icon: <Zap className="h-6 w-6 text-cyan-400" />, title: "Demand Capture", desc: "We identify and capture high-intent demand at the moment someone needs legal help after an accident — through search, content, and structured digital infrastructure.", role: "Acquisition Layer" },
    { step: "02", icon: <Filter className="h-6 w-6 text-cyan-400" />, title: "Intake Control", desc: "Every opportunity passes through our 6-layer qualification framework before reaching your team. We screen for injury type, timing, liability, geography, and case fit.", role: "Qualification Layer" },
    { step: "03", icon: <RefreshCw className="h-6 w-6 text-cyan-400" />, title: "Opportunity Continuity", desc: "Cases that stall after first contact enter our structured recovery system. Follow-up sequences, re-engagement protocols, and timing-based outreach designed to recover value that would otherwise be lost.", role: "Recovery Layer" },
  ];
  ...
  return (
    <section ref={ref} className="py-14 sm:py-18 lg:py-22">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-5 lg:grid-cols-3">
          {pillars.map((pillar, i) => (
            <motion.div key={pillar.title} variants={staggerItem} className="card-hover relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-7">
              {/* Step number */}
              <div className="absolute top-5 right-5 text-[2.5rem] font-bold text-white/[0.04] font-mono leading-none">{pillar.step}</div>
...
function SystemSpecsSection() {
  const { ref, isInView } = useScrollReveal(0.1);
  const specs = [
    { label: "Qualification Layers", value: "6", desc: "Before any opportunity reaches your intake" },
    { label: "Max Firms Per Metro", value: "3", desc: "Hard cap — no exceptions" },
    { label: "Target Response Window", value: "<5 min", desc: "From opportunity delivery to first contact" },
    { label: "Recovery Protocols", value: "Active", desc: "Structured follow-up for stalled opportunities" },
    { label: "Reporting Transparency", value: "100%", desc: "Full visibility into pipeline performance" },
    { label: "Compliance Standard", value: "Bar-Aligned", desc: "Built for legal advertising compliance" },
  ];
  ...
  return (
    <section ref={ref} className="py-14 sm:py-18 lg:py-22">
      <div className="mx-auto max-w-5xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {specs.map((spec) => (
            <motion.div key={spec.label} variants={staggerItem} className="rounded-xl border border-white/[0.06] bg-white/[0.02] px-5 py-4 flex items-start gap-4">
              <div className="text-[1.375rem] font-bold text-cyan-400 font-mono flex-shrink-0 min-w-[3.5rem]">{spec.value}</div>
              <div>
...
function HowItWorksSection() {
  const { ref, isInView } = useScrollReveal(0.1);
  const steps = [
    { num: "01", title: "Apply for Access", desc: "Submit your firm details through our review process. We evaluate market availability, firm capacity, and alignment with our quality standards.", icon: <Shield className="h-5 w-5 text-cyan-400" /> },
    { num: "02", title: "System Activation", desc: "Once approved, we configure your market zone, set up qualification parameters, and activate demand capture infrastructure in your area.", icon: <Zap className="h-5 w-5 text-cyan-400" /> },
    { num: "03", title: "Qualified Delivery", desc: "Screened case opportunities are routed directly to your intake team with full context — injury type, timing, liability indicators, and contact details.", icon: <Route className="h-5 w-5 text-cyan-400" /> },
    { num: "04", title: "Optimize & Scale", desc: "Transparent reporting shows what is working. Recovery protocols capture stalled opportunities. The system compounds as your market matures.", icon: <TrendingUp className="h-5 w-5 text-cyan-400" /> },
  ];
  ...
  return (
    <section ref={ref} id="how-it-works" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((step) => (
            <motion.div key={step.num} variants={staggerItem} className="card-hover relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="rounded-xl border border-cyan-400/12 bg-cyan-400/[0.04] p-2.5">
                  {step.icon}
                </div>
                <span className="text-[2rem] font-bold text-white/[0.05] font-mono">{step.num}</span>
              </div>
    ...
    <section ref={ref} className="py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, rgba(245,158,11,0.06) 0%, rgba(251,191,36,0.02) 50%, rgba(255,255,255,0.02) 100%)" }}
        >
          <div className="absolute top-0 right-0 w-48 h-48 rounded-full opacity-30" style={{ background: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 60%)" }} />
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <div className="mt-4 space-y-2.5">
                {["Why 73% of PI leads never convert (and how to fix it)", "The 6-layer qualification framework", "Market protection strategies that eliminate competition"].map((item) => (
            ...
            <div className="text-center lg:text-right">
              <button className="inline-flex items-center gap-2.5 rounded-full px-7 py-3.5 text-[14px] font-semibold text-black transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_60px_rgba(245,158,11,0.3)]" style={{ background: "linear-gradient(135deg, #F59E0B 0%, #FBBF24 50%, #F59E0B 100%)" }}>
                <Download className="h-4 w-4" />
                Download Free Playbook
              </button>
              <p className="mt-3 text-[12px] text-[#7A8290]">No spam. No fluff. Just the framework.</p>
            </div>
          </div>
        </motion.div>
      </div>
...
function TrustArchitectureSection() {
  const { ref, isInView } = useScrollReveal(0.1);
  const trustSignals = [
    { icon: <Shield className="h-5 w-5 text-cyan-400" />, title: "Market-Capped Exclusivity", desc: "Each market is protected. We limit the number of firms per region to preserve lead quality and prevent oversaturation." },
    { icon: <Award className="h-5 w-5 text-cyan-400" />, title: "Review-First Onboarding", desc: "Every firm is evaluated before access is granted. We work with firms that meet our intake quality and capacity standards." },
    { icon: <BarChart3 className="h-5 w-5 text-cyan-400" />, title: "Transparent Reporting", desc: "Full visibility into case flow activity, qualification metrics, and opportunity handling — no black boxes." },
    { icon: <Lock className="h-5 w-5 text-cyan-400" />, title: "Compliance-First Design", desc: "Built with legal advertising compliance in mind. No misleading claims. No guaranteed outcomes. Structured for ethical lead handling." },
    { icon: <Phone className="h-5 w-5 text-cyan-400" />, title: "Dedicated Support", desc: "Every partner firm has a direct line to our team. No ticket queues. No chatbots. Real people who understand case acquisition." },
    { icon: <Target className="h-5 w-5 text-cyan-400" />, title: "Qualification Standards", desc: "Every opportunity passes through our screening layer before reaching your intake team. We focus on fit, not just volume." },
  ];
  ...
  return (
    <section ref={ref} id="trust" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {trustSignals.map((signal) => (
            <motion.div key={signal.title} variants={staggerItem} className="card-hover rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 transition duration-300 hover:border-cyan-400/10">
  ...
  return (
    <section ref={ref} className="py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-7 sm:p-9 text-center mb-6">
          ...
          <div className="flex items-center justify-center gap-8 sm:gap-12 mb-6">
            ...
            <div>
              <div className="text-[2rem] sm:text-[2.5rem] font-bold text-amber-400 font-mono">25</div>
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-3">
          {[
            { quote: "The market-capped model is the right approach. Oversaturation is what kills lead quality in legal.", name: "Legal Marketing Advisor", role: "15+ Years in PI Marketing" },
            { quote: "Most firms do not have a lead problem. They have an intake discipline problem. CasePort addresses the real gap.", name: "Law Firm Growth Consultant", role: "Scaled 40+ PI Firms" },
            { quote: "The qualification layer is what separates this from every other lead gen service I have evaluated.", name: "PI Firm Operations Director", role: "Multi-State Practice" },
          ].map((testimonial) => (
            <motion.div key={testimonial.name} variants={staggerItem} className="card-hover rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
              <MessageCircle className="h-4 w-4 text-cyan-400/40 mb-4" />
              <p className="text-[15px] text-[#D4D8E0] leading-[1.75] mb-5">&ldquo;{testimonial.quote}&rdquo;</p>
              <div>
        ...
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="mt-5 text-center">
...
function FounderVideoSection() {
  ...
  return (
    <section ref={ref} className="py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center mb-8">
        ...
        <motion.div variants={scaleIn} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <div className="relative group cursor-pointer rounded-2xl border border-white/[0.08] overflow-hidden aspect-video" style={{ background: "linear-gradient(135deg, rgba(0,212,255,0.04) 0%, rgba(124,92,255,0.03) 50%, rgba(0,0,0,0.2) 100%)" }}>
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <p className="mt-5 text-[15px] text-[#9CA3AF] font-medium">Watch the 90-Second Overview</p>
...
function FAQSection() {
  ...
  return (
    <section ref={ref} id="faq" aria-label="Frequently Asked Questions about CasePort" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center max-w-3xl mx-auto mb-12">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <Accordion type="single" collapsible className="space-y-2.5">
            {faqs.map((faq, i) => (
              <AccordionItem key={i} value={`faq-${i}`} className="rounded-2xl border border-white/[0.06] bg-white/[0.02] px-6 overflow-hidden data-[state=open]:border-cyan-400/10 data-[state=open]:bg-white/[0.03] transition-colors duration-300">
      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8 text-center">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <div className="inline-flex items-center gap-2.5 rounded-full border border-amber-500/15 bg-amber-500/[0.04] px-5 py-2.5 mb-6">
            ...
            <span className="text-[12px] font-semibold text-amber-400 uppercase tracking-[0.15em]">Limited Availability</span>
          </div>

          <h2 className="text-[1.75rem] sm:text-[2.25rem] lg:text-[2.75rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
            We Partner With a Maximum of
            <br />
            <span className="text-gradient-gold text-[2.25rem] sm:text-[3rem] lg:text-[3.5rem]">3 Firms Per Metro Area.</span>
          </h2>
      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8 text-center">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          ...
          <div className="mt-7 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a href="/request-access"
              className="rounded-full px-8 py-3.5 text-sm font-semibold text-white shadow-[0_0_40px_rgba(0,212,255,0.3)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_50px_rgba(0,212,255,0.4)] inline-block"
              style={{ background: "linear-gradient(135deg, #00B4D8 0%, #5BB6C9 40%, #7C5CFF 100%)" }}
            >
              Request Private Access
            </a>
            <a href="#roi-calculator" className="group flex items-center gap-2 text-[14px] text-[#9CA3AF] transition hover:text-white">
              See ROI Projection
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#system" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">For Law Firms</a>
              <a href="#how-it-works" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">How It Works</a>
              <a href="#roi-calculator" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">ROI Projection</a>
              <a href="#trust" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">Why CasePort</a>
              <a href="#faq" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">FAQ</a>
            </div>
          </div>
          <div>
            <div className="system-label text-[#7A8290] mb-3">Resources</div>
            <div className="space-y-2">
              <a href="#insights" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">Insights</a>
              <a href="#intelligence" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">Intelligence</a>
              <a href="#injured" className="block text-[14px] text-[#9CA3AF] transition hover:text-white">Injured?</a>
            </div>
          </div>
          <div>
            <div className="system-label text-[#7A8290] mb-3">Contact</div>
            <div className="space-y-2 text-[14px] text-[#9CA3AF]">
              <a href="mailto:access@caseport.io" className="transition hover:text-white">access@caseport.io</a>
            </div>
          </div>
        </div>
