...
import { InjuryTypePage, injuryTypeMeta } from "@/components/pages/InjuryTypePage";
import { InjurySpokePage, injurySpokeMeta } from "@/components/pages/InjurySpokePage";
import {
  DelayedSymptomsPage,
  delayedSymptomsMeta,
  WhenToSeeDoctorPage,
  whenToSeeDoctorMeta,
} from "@/components/pages/StandaloneInjuryPages";
