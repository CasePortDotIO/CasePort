...
import { AdjusterPlaybook } from "@/components/widgets/AdjusterPlaybook";
import { CityFinder } from "@/components/widgets/CityFinder";
import { HubSearch } from "@/components/widgets/HubSearch";
import { SettlementEstimator } from "@/components/widgets/SettlementEstimator";
import { StateComparison } from "@/components/widgets/StateComparison";
import { StateMap } from "@/components/widgets/StateMap";
import { StatuteCountdown } from "@/components/widgets/StatuteCountdown";
import {
  accidentTypeOrder,
  accidentTypes,
  negColor,
...
import { article, breadcrumb, faqSchema, orgGraph, type Faq } from "@/lib/schema";
...
const negRows: [string, string, string][] = [
  ...
  ["Pure comparative", "Recover at any fault %, reduced by your share", "CA · NY · FL* · WA · AZ · …"],
];
      ...
      <section className="hero">
        <div className="container-5">
          ...
          <p className="hero-lede">
            State-specific negligence rules. City-level guides. Step-by-step first-hour actions. Attorney-reviewed,
            updated quarterly. No jargon. No sales pitch.
          </p>
        ...
        <div className="container-5">
          <div className="capsule r">
            ...
            <p className="cap-lead">
              After a U.S. accident, four things decide what your claim is worth: your state&apos;s negligence rule, the
              filing deadline, the evidence you preserve in the first 72 hours, and how the settlement is calculated.
              Get these right and you protect the full value of your case.
            </p>
            <div className="cap-grid">
              <div className="cap-fact">
                <Icon name="check2" />
                <span>
                  <b>Negligence rule decides everything.</b> Your state&apos;s fault rule is applied <b>before</b> any
                  payment. In contributory-negligence states (VA, MD, DC, NC, AL) even <b>1% fault bars 100%</b> of
                  recovery.
                </span>
              </div>
              <div className="cap-fact">
                <Icon name="check2" />
                <span>
                  <b>Deadlines are hard and vary.</b> The statute of limitations runs <b>1 to 6 years</b> by state. Miss
                  it and the claim is permanently barred — but evidence disappears far sooner.
                </span>
              </div>
              <div className="cap-fact">
                <Icon name="check2" />
                <span>
                  <b>The first 72 hours are decisive.</b> Surveillance footage is overwritten within <b>72 hours</b>;
                  witness memory fades within days. What you document and say early sets the ceiling on your claim.
                </span>
              </div>
              <div className="cap-fact">
                <Icon name="check2" />
                <span>
                  <b>Settlements follow a formula.</b> Adjusters multiply economic damages by <b>1.5×–5×</b> for
                  severity. First offers run <b>40–60% below</b> final value by design.
                </span>
              </div>
            </div>
                  ...
                  <div className="keyfacts" style={{ marginTop: "1rem" }}>
                    {qa.keyFacts.slice(0, 2).map((f, i) => (
                      <div className="keyfact" key={i}>
                        ...
                        <span style={{ fontWeight: 600, fontSize: ".95rem", lineHeight: 1.5 }}>{f}</span>
                      </div>
                    ))}
                  </div>
        ...
        <div className="container-5">
          ...
          <div className="grid grid-3">
            ...
            <Link href="/accidents/resources" className="card link r">
              ...
              <p>Browse every quick answer, statute deadline, and negligence rule across all 50 states and DC.</p>
              <span className="card-link" style={{ marginTop: "1rem" }}>
                Learn more <Icon name="arrow" />
              </span>
            </Link>
        ...
        <div className="container-5">
          <div className="section-head">
            ...
            <p className="section-sub">
              Every state sets its own negligence rule, filing deadline, damage caps, and accident statistics. The four
              below show the four fault systems that exist in America — open any state for its full profile, with
              city-level guides rolling out nationwide.
            </p>
          </div>
            ...
            {featured.map((ab) => {
              ...
              return (
                <Link key={ab} href={`/accidents/${stateSlug(ab)}`} className="card link r">
                  ...
                  >
                    <h3>{s.name}</h3>
                    <span className="pill-rule" style={{ background: color + "18", color, fontSize: ".72rem" }}>
                      {s.abbr}
                    </span>
                  </div>
                  ...
                  <span className="card-link" style={{ marginTop: ".9rem" }}>
                    Open {s.name} guide <Icon name="arrow" />
                  </span>
                </Link>
              );
            })}
