...
import { article, faqSchema, breadcrumb, speakable, itemList, orgGraph } from "@/lib/schema";
import { stateLawTopics, stateLawFor } from "@/data";
import { reviewer } from "@/lib/constants";
import { toSections, readingMinutes } from "@/lib/article";
        ...
        <div className="container-5">
          ...
          <div style={{ marginTop: "1.5rem" }}>
            <Link href={`/accidents/${r.slug}`} className="card-link">
              Back to the {s.name} overview <Icon name="arrow" />
            </Link>
          </div>
        </div>
      </section>
