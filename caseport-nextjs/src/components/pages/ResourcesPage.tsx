...
import { article, breadcrumb, orgGraph } from "@/lib/schema";
...
export const resourcesMeta = {
  ...
  description:
    "Index of every quick answer, accident-type guide, and state law profile.",
      ...
      <section className="page-intro">
        <div className="container-5">
          ...
          <p className="section-sub" style={{ marginTop: "1rem" }}>
            Every quick answer, accident-type guide, state law profile, and city
            guide in one place — attorney-reviewed and updated quarterly.
          </p>
          ...
          <div className="card r">
            <ul className="keyfacts" style={{ listStyle: "none" }}>
              {stateLawTopics.map((t) => (
                <li className="keyfact" key={t.slug}>
                  ...
                  <span>
                    <b style={{ color: "var(--teal)" }}>{t.label}</b> — available for all
                    50 states &amp; DC at{" "}
            ...
            <div style={{ marginTop: "1.5rem", display: "flex", gap: ".75rem", flexWrap: "wrap" }}>
              <Link href="/accidents/california" className="btn btn-teal btn-sm">
                Browse by state <Icon name="arrow" />
              </Link>
