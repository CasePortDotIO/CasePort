      ...
      <div className="container-5">
        <div className="section-head">
          ...
          <p className="section-sub">
            Local accident data, the controlling state law, and immediate
            first-hour actions — metro by metro. Live now across our launch markets
            and expanding to every major U.S. city.
          </p>
        </div>
        ...
        <p
          ...
          id="cityEmpty"
          style={{ display: anyVisible ? "none" : "block" }}
        >
          No live metro matches that yet — but every state has a complete law
          profile.{" "}
          <Link href="/accidents/california">
            Browse accident law by state <Icon name="arrow" />
          </Link>
        </p>
      </div>
    </section>
