...
const SOURCES_BASE = [
  ...
  { name: 'American Bar Association — Motor Vehicle Accidents', url: 'https://www.americanbar.org' },
]
...
function whatToDoBlocks(authorId: number) {
  const data = {
    'car-accident': {
      ...
      steps: [
        { stepName: 'Check for Injuries', stepDescription: 'Ensure everyone is safe. Call 911 if anyone needs medical attention — and request police even for minor accidents.' },
        { stepName: 'Move to Safety', stepDescription: 'If it is safe to do so, move vehicles out of active traffic to prevent a second collision.' },
        { stepName: 'Document Everything', stepDescription: 'Photograph vehicle damage, the scene, road conditions, traffic signals, skid marks, and your injuries from multiple angles.' },
        { stepName: 'Collect Information', stepDescription: "Get names, phone numbers, and insurance details from all parties — and the other driver's license plate." },
        { stepName: 'Get Witness Statements', stepDescription: 'Ask witnesses for contact information and a brief account of what they saw while memory is fresh.' },
        { stepName: 'Report to Police', stepDescription: 'File a police report and record the report number. Then contact a representative within 24 hours.' },
      ],
      facts: [
    ...
    'truck-accident': {
      ...
      steps: [
        ...
        { stepName: 'Document the Scene', stepDescription: 'Photograph all vehicles, cargo, skid marks, road conditions, and your injuries. Capture the truck\'s DOT number and carrier info.' },
    ...
    'motorcycle-accident': {
      ...
      steps: [
        { stepName: 'Get Medical Care', stepDescription: 'Motorcycle injuries are often catastrophic. Seek emergency medical care immediately, even if you feel fine.' },
        ...
        { stepName: 'Identify the Other Driver', stepDescription: "Get the other driver's license, insurance, and vehicle registration. Note any violations you observed." },
    ...
    'pedestrian-accident': {
      ...
      steps: [
        ...
        { stepName: 'Identify the Driver', stepDescription: "Get the driver's license, insurance, and vehicle plate. Note the driver\'s behavior at the scene." },
    ...
    'bicycle-accident': {
      ...
      steps: [
        { stepName: 'Get Medical Care', stepDescription: 'Bicycle injuries are often catastrophic — traumatic brain injury, spinal damage, fractures. Seek immediate care.' },
        ...
        { stepName: 'Identify the Driver', stepDescription: "Get the driver's license, insurance, and vehicle plate. Note what the driver did before impact." },
    ...
    'slip-and-fall': {
      ...
      steps: [
        ...
        { stepName: 'Report the Incident', stepDescription: 'Notify the property owner or manager immediately. Get a copy of any incident report they create.' },
    ...
    'dog-bite': {
      ...
      steps: [
        { stepName: 'Get Medical Care', stepDescription: 'Dog bites cause serious infections and require immediate medical treatment. Clean wounds thoroughly and seek care.' },
        { stepName: 'Identify the Dog & Owner', stepDescription: 'Get the owner\'s name, address, and dog\'s vaccination records. Note the dog\'s behavior.' },
        { stepName: 'Report to Animal Control', stepDescription: 'Report the bite to local animal control. This creates an official record of the incident.' },
    ...
    'workplace-injury': {
      ...
      steps: [
        ...
        { stepName: 'Preserve Evidence', stepDescription: 'Defective equipment, maintenance records, and surveillance footage are critical. Preserve everything.' },
  ...
  return [
    ...
    makeFAQ([
      { q: `What is the first thing to do after a ${key.replace('-', ' ')}?`, a: 'Ensure everyone is safe and call 911 — request police even for a minor incident. The official report is the single most important document in your claim.' },
      { q: `Should I see a doctor after a ${key.replace('-', ' ')} even if I feel fine?`, a: 'Yes. Adrenaline masks injuries, and some conditions take hours or days to appear. A same-day medical record also connects your injuries to the event, which protects a claim.' },
      { q: `What should I not do after a ${key.replace('-', ' ')}?`, a: 'Do not admit fault, apologize, or say you are fine; do not give the other side\'s insurer a recorded statement; and do not accept a quick settlement before you know the full extent of your injuries.' },
    ]),
...
function settlementBlocks(authorId: number) {
  return [
    ...
    makeFAQ([
      ...
      { q: 'How is a settlement calculated?', a: 'Adjusters total economic damages (medical bills, lost wages) and multiply by roughly 1.5x to 5x based on severity. Your state\'s negligence rule is then applied.' },
...
function statuteBlocks(authorId: number) {
  return [
    ...
    makeFAQ([
      { q: 'How long do I have to file?', a: 'It depends on your state — typically 1 to 6 years from the date of injury, most commonly 2 to 3. The deadline is a hard cutoff: miss it and the claim is permanently barred.' },
...
const PILLARS = [
  {
    ...
    heroSubtitle: 'From the first 72 hours after your accident to the moment you receive your settlement — everything you need to know.',
    metaTitle: 'Car Accident Claims Guide | Car Accident Settlement Help',
    metaDescription: 'Complete guide to car accident claims: settlements, deadlines, attorney selection, and what your claim is really worth.',
  },
  {
    ...
    heroSubtitle: 'Federal regulations, black box data, and higher insurance limits — what you need to know after a truck accident.',
    metaTitle: 'Truck Accident Claims Guide | Settlements & Legal Help',
    metaDescription: 'Complete guide to truck accident claims: higher settlements, federal trucking regulations, and why truck cases are worth more.',
  },
  {
    ...
    heroSubtitle: 'Severe injuries, insurance bias, and clear liability — what every motorcyclist needs to know after a crash.',
    metaTitle: 'Motorcycle Accident Claims Guide | Settlements & Legal Help',
    metaDescription: 'Complete guide to motorcycle accident claims: overcoming bias, proving liability, and maximizing your recovery.',
  },
  {
    ...
    heroSubtitle: 'Clear liability, severe injuries, and vulnerable road user protections — what you need to know after a pedestrian accident.',
    metaTitle: 'Pedestrian Accident Claims Guide | Settlements & Legal Help',
    metaDescription: 'Complete guide to pedestrian accident claims: liability, vulnerable road user protections, and settlements.',
  },
  {
    ...
    heroSubtitle: 'Severe injuries, driver negligence, and vulnerable road user protections — what every cyclist needs to know.',
    metaTitle: 'Bicycle Accident Claims Guide | Settlements & Legal Help',
    metaDescription: 'Complete guide to bicycle accident claims: proving driver fault, vulnerable road user laws, and settlements.',
  },
  {
    ...
    heroSubtitle: 'Uber, Lyft, and complex liability — what you need to know after a rideshare accident.',
    metaTitle: 'Rideshare Accident Claims Guide | Uber & Lyft Settlements',
    metaDescription: 'Complete guide to rideshare accident claims: complex liability, insurance coverage, and settlements.',
  },
  {
    slug: 'slip-and-fall',
    ...
    heroSubtitle: 'Property owner negligence, evidence preservation, and what it takes to win a slip and fall claim.',
    metaTitle: 'Slip and Fall Claims Guide | Premises Liability Help',
    metaDescription: 'Complete guide to slip and fall claims: proving premises liability, evidence preservation, and settlements.',
  },
  {
    slug: 'dog-bites',
    dataKey: 'dog-bite',
    ...
    heroSubtitle: 'Strict liability, severe injuries, and permanent scarring — what you need to know after a dog bite.',
    metaTitle: 'Dog Bite Claims Guide | Settlements & Legal Help',
    metaDescription: 'Complete guide to dog bite claims: strict liability, injury documentation, and settlements.',
  },
  {
    ...
    metaDescription: 'Complete guide to workplace injury claims: workers\' comp limits, third-party claims, and full damages.',
  },
  {
    slug: 'wrongful-death',
    ...
    heroSubtitle: 'When negligence takes a life — seeking justice and maximum recovery for your family.',
    metaTitle: 'Wrongful Death Claims Guide | Family Compensation Help',
    metaDescription: 'Complete guide to wrongful death claims: damages, filing deadlines, and seeking justice for your family.',
  },
  {
    ...
    heroSubtitle: 'When a healthcare provider\'s negligence causes harm — what counts, what it takes to prove, and why these cases are different.',
    metaTitle: 'Medical Malpractice Claims Guide | Proving Negligence',
    metaDescription: 'Complete guide to medical malpractice claims: standard of care, expert testimony, and damage caps.',
  },
]
...
const SPOKE_DEFS = [
  {
    ...
    metaDescSuffix: 'Step-by-step guide to the first 72 hours after your accident: medical care, evidence, insurance, and legal deadlines.',
    schemaType: 'HowTo',
  ...
  },
  {
    ...
    metaDescSuffix: 'How settlements are calculated: multiplier method, severity ranges, and what reduces your final payout.',
  ...
  },
  {
    ...
    metaDescSuffix: 'When you need a lawyer and when you might not: injury severity, liability disputes, contingency fees, and free consultations.',
    schemaType: 'FAQPage',
    voiceAnswerPrefix: '',
  },
  {
    ...
    metaDescSuffix: 'Filing deadlines for claims — typically 1 to 6 years. Missing the deadline permanently bars your claim.',
    schemaType: 'FAQPage',
    voiceAnswerPrefix: '',
  },
]
    ...
    for (const spoke of SPOKE_DEFS) {
      ...
      if (spoke.slug === 'what-to-do-after') {
        ...
        blocks = [
          ...
          makeCTA('Get a Free Case Review', 'Find out what your claim is worth — at no cost, with no obligation.'),
        ]
      }
