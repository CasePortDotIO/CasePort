...
function GlassCard({ children, className = "", hover = true, style }: { children: React.ReactNode; className?: string; hover?: boolean; style?: React.CSSProperties }) {
  return (
    <div
      className={`glass-panel p-8 md:p-10 ${hover ? "transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg" : ""} ${className}`}
      style={style}
    >
      {children}
    </div>
    ...
    <div className="w-full max-w-md">
      ...
      {step === 1 && (
        <div className="space-y-6">
          ...
          <button onClick={() => setStep(2)} className="cta-primary w-full h-12 flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:scale-105">
      ...
      >
        <div className="container flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#access" className="cta-primary text-sm h-10 px-5 flex items-center gap-1.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105">
              Claim Your Access <ArrowRight className="w-3.5 h-3.5" />
            </a>
          </div>
          <a href="#access" className="md:hidden cta-primary text-sm h-9 px-4 flex items-center gap-1.5 rounded-lg transition-all duration-300 hover:shadow-lg">
            Claim Access
          </a>
        </div>
      </nav>
            ...
            <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                >
                  ...
                  <br />
                  <span className="text-gradient-cyan">Not Lead Roulette.</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-8">
                  <a href="/request-access" className="cta-primary h-12 flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:scale-105">
                    Claim Your Market Access <ArrowRight className="w-4 h-4" />
                  </a>
          ...
          <div className="container max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6" style={{ color: "#F1F3F5", letterSpacing: "-0.04em" }}>
                ...
                <br />
                <span className="text-gradient-cyan">Not Wasting Money.</span>
              </h2>
            </div>
          ...
          <div className="container max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-8" style={{ color: "#F1F3F5", letterSpacing: "-0.04em" }}>
                ...
                <br />
                <span className="text-gradient-cyan">Built for PI Firms.</span>
              </h2>
          ...
          <div className="container max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-8" style={{ color: "#F1F3F5", letterSpacing: "-0.04em" }}>
                ...
                <br />
                <span className="text-gradient-cyan">34% Recovery Rate.</span>
              </h2>
            </div>
          ...
          <div className="container max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-8" style={{ color: "#F1F3F5", letterSpacing: "-0.04em" }}>
                ...
                <br />
                <span className="text-gradient-cyan">Real Numbers. Real Results.</span>
              </h2>
            </div>
            <ROICalculator />
          </div>
          ...
          <div className="container max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-8" style={{ color: "#F1F3F5", letterSpacing: "-0.04em" }}>
                You See Everything.
                <br />
                <span className="text-gradient-cyan">No Black Box.</span>
              </h2>
            </div>
          ...
          <div className="container max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-8" style={{ color: "#F1F3F5", letterSpacing: "-0.04em" }}>
                ...
                <br />
                <span className="text-gradient-cyan">No Shortcuts.</span>
              </h2>
            </div>
          ...
          <div className="container max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-8" style={{ color: "#F1F3F5", letterSpacing: "-0.04em" }}>
                Your Dashboard.
                <br />
                <span className="text-gradient-cyan">Full Transparency.</span>
              </h2>
              <p className="text-lg leading-relaxed max-w-2xl mx-auto" style={{ color: "#B0B8C4" }}>
