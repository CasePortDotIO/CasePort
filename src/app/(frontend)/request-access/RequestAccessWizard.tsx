    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background:
            'radial-gradient(ellipse, rgba(34,211,238,0.035) 0%, rgba(139,92,246,0.015) 50%, transparent 70%)',
          borderRadius: '50%',
        }}
      ...
      <main className="relative z-10 flex-1 flex flex-col px-4 sm:px-8 pb-4 sm:pb-5">
        <div className="max-w-6xl mx-auto w-full flex flex-col flex-1">
          ...
          <AnimatePresence>
            {!heroExpanded && (
              ...
              >
                ...
                <p
                  className="text-[13px] text-white/45 mt-1.5"
                  style={{ fontFamily: 'var(--font-geist)', fontWeight: 500 }}
                >
          ...
          <div className="mb-5 sm:mb-6 flex-shrink-0">
            <ProgressBar currentPhaseIndex={currentPhaseIndex} progressPercent={progressPercent} />
          </div>
              ...
              >
                ...
                <div className="absolute top-0 left-0 right-0 h-[1px] overflow-hidden rounded-t-2xl">
                  <motion.div
                    ...
                    style={{
                      background:
                        'linear-gradient(90deg, transparent 0%, rgba(34,211,238,0.3) 30%, rgba(139,92,246,0.2) 70%, transparent 100%)',
                    }}
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            CasePort is a case acquisition platform, not a law firm. No attorney-client relationship
            is formed. No referral fees paid to or accepted from attorneys. All arrangements comply
