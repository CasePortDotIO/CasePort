...
import TestingInjuredNewClient from './TestingInjuredNewClient'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.caseport.io'}/testinginjurednew`,
  },
  openGraph: {
    title: 'Injured in an Accident? Get Connected to a Personal Injury Lawyer Fast | CasePort',
    description: 'Find out if you may have a personal injury case. Free, confidential case check.',
    url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.caseport.io'}/testinginjurednew`,
    type: 'website',
  },
}

export default function TestingInjuredNewPage() {
  return <TestingInjuredNewClient />
}