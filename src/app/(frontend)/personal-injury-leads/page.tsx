...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.caseport.io'}/personal-injury-leads`,
  },
  openGraph: {
    title: 'Personal Injury Leads for Law Firms | CasePort',
    description:
      'Structured, disciplined case flow for PI firms. Territorial exclusivity. 46 markets. 3 firms each.',
    url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.caseport.io'}/personal-injury-leads`,
    type: 'website',
  },
}
