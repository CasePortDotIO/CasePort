...
function SystemLabel({ children }: { children: React.ReactNode }) {
  return (
    <span
      className="system-label inline-block mb-6"
      style={{
        color: 'oklch(60% .015 250)',
        fontSize: '12px',
  ...
  return (
    <div className="border-b border-white/[0.06]">
      <button
        ...
        aria-expanded={open}
      >
        <span className="text-base md:text-lg font-medium pr-4" style={{ color: '#F1F3F5' }}>
          {question}
        </span>
        {open ? (
          <ChevronUp
            className="w-5 h-5 shrink-0 transition-colors duration-300"
            style={{ color: 'oklch(78% .13 195)' }}
          />
        ) : (
          <ChevronDown
            className="w-5 h-5 shrink-0 transition-colors duration-300"
      ...
      >
        <p className="pb-6 text-base leading-relaxed" style={{ color: '#B0B8C4' }}>
          {answer}
        </p>
      </div>
    </div>
  ...
  return (
    <div ref={ref} className="mb-6">
      <div className="flex justify-between mb-2">
        <span className="text-sm" style={{ color: '#B0B8C4' }}>
          {label}
        </span>
        <span
    ...
    <div className="w-full max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="auto" className="bg-[rgb(3,6,8)]">
                Auto Accidents
              </option>
              <option value="slip" className="bg-[rgb(3,6,8)]">
                Slip & Fall
              </option>
              <option value="medical" className="bg-[rgb(3,6,8)]">
                Medical Malpractice
              </option>
              <option value="workers" className="bg-[rgb(3,6,8)]">
          ...
          <div>
            ...
            >
              ...
              <option value="5k-10k" className="bg-[rgb(3,6,8)]">
                $5,000 – $10,000
              </option>
              <option value="10k-25k" className="bg-[rgb(3,6,8)]">
                $10,000 – $25,000
              </option>
              <option value="25k-50k" className="bg-[rgb(3,6,8)]">
                $25,000 – $50,000
              </option>
              <option value="50k+" className="bg-[rgb(3,6,8)]">
                $50,000+
              </option>
            </select>
          </div>
          <Button
            variant="gradient"
            onClick={() => setStep(2)}
            className="w-full h-12 flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:scale-105"
          >
      ...
      {step === 2 && (
        <div className="space-y-6">
          ...
          <div
            className="glass-panel p-5 flex items-start gap-3 rounded-lg"
            style={{
          ...
          >
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#B0B8C4' }}>
              <strong>Pre-Funded Wallet:</strong> You fund your wallet. We deliver qualified
              opportunities. You only pay when a case meets our mutual agreement.
            </p>
          </div>
          ...
          <div className="glass-panel p-5 flex items-start gap-3 rounded-lg">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#B0B8C4' }}>
              Your information is reviewed by our qualification team. We assess market fit,
          ...
          <div className="flex gap-3">
            <button
              onClick={() => setStep(1)}
              className="cta-secondary flex-1 h-12 rounded-lg font-medium transition-all duration-300 hover:opacity-80"
            >
              Back
            </button>
            <button
          ...
          <p className="text-center text-xs" style={{ color: '#6B7280' }}>
            By submitting, you agree to our qualification review process. No payment required at
            this stage.
          </p>
        </div>
      )}
  ...
  return (
    <main className="relative overflow-hidden" style={{ background: 'rgb(3, 6, 8)' }}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0" aria-hidden="true">
        <div
          className="glow-orb absolute top-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full"
          style={{
            background: 'radial-gradient(circle, rgba(34,211,238,0.08) 0%, transparent 70%)',
          }}
        />
        <div
          className="glow-orb absolute top-[40%] right-[-15%] w-[500px] h-[500px] rounded-full"
          style={{
        ...
        />
        <div
          className="glow-orb absolute bottom-[-10%] left-[30%] w-[700px] h-[700px] rounded-full"
          style={{
      ...
      <div className="relative z-10">
            ...
            <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <h1 style={{ display: 'none' }}>
                  Case Acquisition System for Personal Injury Law Firms - www.CasePort.io
                </h1>
                <p
                  className="text-base md:text-lg leading-relaxed mb-4 max-w-xl"
                  style={{ color: '#B0B8C4' }}
                >
                  Most personal injury firms waste{' '}
                  <span style={{ color: 'oklch(78% .13 195)' }}>$15,000–$50,000 monthly</span> on
                  leads that never convert. Shared lists. Unqualified contacts. Zero accountability.
                </p>
                <p className="text-sm leading-relaxed mb-6 max-w-xl" style={{ color: '#B0B8C4' }}>
                  The average PI firm loses{' '}
                  <span style={{ color: 'oklch(78% .13 195)' }}>
                    40–60% of its marketing spend to lead decay
                  </span>{' '}
                  — opportunities that go cold before intake touches them. We recover{' '}
                  <span style={{ color: 'oklch(78% .13 195)' }}>34% of those cold leads</span>.
                  Minimum firm size:{' '}
                  <span style={{ color: 'oklch(78% .13 195)' }}>5+ attorneys</span>. Minimum monthly
                  budget: <span style={{ color: 'oklch(78% .13 195)' }}>$8,000</span>.
                </p>
                ...
                <div className="flex flex-wrap gap-x-6 gap-y-3">
                  ...
                  >
                    <Lock className="w-3.5 h-3.5" style={{ color: 'oklch(78% .13 195)' }} />{' '}
                  ...
                  >
                    <Shield className="w-3.5 h-3.5" style={{ color: 'oklch(78% .13 195)' }} /> ABA
                    Compliant
                  </span>
                  <span
                    className="flex items-center gap-1.5 text-xs"
                  ...
                  >
                    <FileCheck className="w-3.5 h-3.5" style={{ color: 'oklch(78% .13 195)' }} />{' '}
                ...
                <GlassCard>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      >
                        Opportunities Routed Today
                      </p>
                      <p className="text-4xl font-bold" style={{ color: 'oklch(78% .13 195)' }}>
                        47
                      </p>
                    </div>
                    <div>
                    ...
                    <div className="pt-4 border-t border-white/[0.06]">
                      ...
                      <p className="text-xs mt-2" style={{ color: '#6B7280' }}>
                        3 firms per metro. Limited availability.
                      </p>
                    </div>
                  </div>
                </GlassCard>
        ...
        <Section className="bg-gradient-to-b from-transparent via-white/[0.02] to-transparent">
          <div className="container">
            ...
            <p className="text-center text-xs mt-12" style={{ color: '#6B7280' }}>
              Results vary based on market, practice areas, and firm capacity. For illustrative
              purposes only.
            </p>
          </div>
        </Section>
              ...
              {[
                {
                  firm: 'Texas PI Firm',
                  quote:
                    "Signed 23 cases in Q1. $1.8M case value. First time we've had predictable case flow.",
                  metric: '23',
                  label: 'cases signed',
                },
                {
                  firm: 'California Slip & Fall',
                  quote:
                    'Replaced 3 lead vendors. Cut marketing spend by 40%. Better quality leads.',
                  metric: '40%',
                  label: 'spend reduction',
                },
                {
                  firm: 'Florida Auto Accident',
                  quote:
                    'Went from 8 to 18 cases per month. Zero lead decay. System does the work.',
                  metric: '+125%',
                  label: 'case volume',
                },
              ].map((item, i) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold mb-3" style={{ color: '#F1F3F5' }}>
                    {item.firm}
                  </h3>
                  <p className="text-sm mb-6 leading-relaxed" style={{ color: '#B0B8C4' }}>
                    "{item.quote}"
                  </p>
                  <div className="pt-4 border-t border-white/[0.06]">
                    <p className="text-3xl font-bold mb-1" style={{ color: 'oklch(78% .13 195)' }}>
                      {item.metric}
                    </p>
                    <p
                      className="text-xs"
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg leading-relaxed max-w-2xl mx-auto" style={{ color: '#B0B8C4' }}>
                Every case acquisition opportunity passes through our proprietary qualification
                engine — scoring across injury severity, liability indicators, insurance coverage
                signals, geographic relevance, and 8 additional dimensions specific to personal
                injury case viability.
              </p>
            </div>
            ...
            <GlassCard>
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-lg font-bold mb-8" style={{ color: '#F1F3F5' }}>
                    Scoring Dimensions
                  </h3>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <GlassCard>
                ...
                <h3 className="text-xl font-bold mb-3" style={{ color: '#F1F3F5' }}>
                  Lead Recovery
                </h3>
                <p style={{ color: '#B0B8C4' }}>
                  Opportunities that stall after first contact enter our structured recovery system.
                  Follow-up sequences, re-engagement protocols, and timing-based outreach designed
              ...
              <GlassCard>
                ...
                <p style={{ color: '#B0B8C4' }}>
                  Cases that don't convert on first contact are automatically recycled through our
                  system at optimal timing intervals. We've identified the precise windows when
                  prospects are most receptive to re-engagement.
                </p>
              </GlassCard>
            </div>
          </div>
              ...
              {[
                {
                  icon: Users,
                  title: 'Firm Size',
                  desc: 'Minimum 5+ attorneys. We focus on firms with capacity to handle volume.',
                },
                {
                  icon: Wallet,
                  title: 'Budget Commitment',
                  desc: 'Minimum $8,000/month. This ensures serious commitment and allows us to build your market.',
                },
                {
                  icon: Target,
                  title: 'Practice Focus',
                  desc: 'Auto accidents, slip & fall, medical malpractice. We specialize in high-value PI cases.',
                },
                {
                  icon: FileCheck,
                  title: 'Intake Discipline',
                  desc: "Your firm must have documented intake protocols. We can't fix broken internal processes.",
                },
              ].map((item, i) => {
        ...
        <Section>
          <div className="container mx-auto px-5 sm:px-6 lg:px-8 max-w-3xl mx-auto">
            <GlassCard
              className="border-2"
              style={{ borderColor: 'rgba(139, 92, 246, 0.3)', borderWidth: '2px' }}
            >
              <div className="flex items-start gap-4">
                <Shield className="w-8 h-8 mt-1 shrink-0" style={{ color: '#8B5CF6' }} />
                <div>
                  <h3 className="text-2xl font-bold mb-4" style={{ color: '#F1F3F5' }}>
                    90-Day Commitment Guarantee
                  </h3>
                  <p className="mb-4" style={{ color: '#B0B8C4' }}>
                    Commit to 90 days with www.CasePort.io. If you don't see measurable case flow
                    improvement (minimum 15% increase in signed cases or 20% reduction in
                    cost-per-case), we'll refund your unused wallet balance. No questions. No fine
                    print. Minimum commitment: $8,000. Refund processed within 5 business days.
                  </p>
                  <p style={{ color: '#6B7280', fontSize: '14px' }}>
                    This guarantee only applies to firms that meet our qualification standards and
                    follow our onboarding protocol. We're betting on ourselves because we know the
                    system works.
                  </p>
                </div>
              </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      >
                        <td className="py-4 px-4" style={{ color: '#F1F3F5' }}>
                          {row.metric}
                        </td>
                        <td className="py-4 px-4" style={{ color: 'oklch(78% .13 195)' }}>
                          {row.value}
                        </td>
                        <td className="py-4 px-4" style={{ color: '#10B981' }}>
                          {row.trend}
                        </td>
                      </tr>
                    ))}
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <GlassCard>
                ...
                <h3 className="text-lg font-bold mb-3" style={{ color: '#F1F3F5' }}>
                  ABA Rule 7.1 Compliance
                </h3>
                <p style={{ color: '#B0B8C4' }}>
                  All communications are truthful and not misleading. No guaranteed outcomes. No
                  false claims about case value or settlement amounts.
                </p>
              </GlassCard>
              <GlassCard>
                ...
                <p style={{ color: '#B0B8C4' }}>
                  Your firm's data, metrics, and case information are protected. We never share
                  client data with other firms or third parties.
                </p>
              </GlassCard>
            </div>
          </div>
        ...
        <Section>
          <div className="container mx-auto px-5 sm:px-6 lg:px-8 max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg leading-relaxed max-w-2xl mx-auto" style={{ color: '#B0B8C4' }}>
                Monitor every case from qualification through close. Real-time analytics, lead
                scoring transparency, and performance metrics all in one institutional-grade
                dashboard.
              </p>
            </div>
          ...
          <div className="container">
            ...
            <nav className="mb-12 pb-8 border-b border-white/[0.06]">
              <p
                ...
                style={{ color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.1em' }}
              >
                Related Topics
              </p>
              <div className="flex flex-wrap gap-3">
                <a
                  href="#how-it-works"
                  className="text-sm px-3 py-2 rounded-lg transition-colors duration-300"
                  style={{ background: 'rgba(255,255,255,0.04)', color: '#B0B8C4' }}
                >
                  How It Works
                </a>
                <a
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-12">
              <div>
                <p className="font-bold mb-4" style={{ color: '#F1F3F5' }}>
                  CASEPORT
                </p>
                <p style={{ color: '#6B7280', fontSize: '14px' }}>
                  Case Acquisition System for Personal Injury Law Firms
                </p>
              </div>
              <div>
                <p className="font-bold mb-4" style={{ color: '#F1F3F5' }}>
            ...
            <div className="border-t border-white/[0.06] pt-8 text-center">
              <p style={{ color: '#6B7280', fontSize: '12px' }}>
                © 2026 www.CasePort.io. All rights reserved. Market-capped. Review-first. For
          ...
          '@graph': [
            {
              ...
              description:
                'Premium case acquisition system for personal injury law firms. Market-capped to 3 firms per metro. Review-first onboarding. Zero lead decay.',
