...
// ─── Accident Category Page Block Library ──────────────────────────────────────

const AccidentCategoryDirectAnswer: Block = {
  slug: 'accidentCategoryDirectAnswer',
...
const AccidentCategoryQuickAnswerStats: Block = {
  slug: 'accidentCategoryQuickAnswerStats',
...
const AccidentCategoryKeyTakeaways: Block = {
  slug: 'accidentCategoryKeyTakeaways',
...
const AccidentCategoryProseSections: Block = {
  slug: 'accidentCategoryProseSections',
...
const AccidentCategoryFAQ: Block = {
  slug: 'accidentCategoryFAQ',
...
const AccidentCategoryStatuteDeadlines: Block = {
  slug: 'accidentCategoryStatuteDeadlines',
...
const AccidentCategoryWhyImportant: Block = {
  slug: 'accidentCategoryWhyImportant',
...
const AccidentCategorySectionTOC: Block = {
  slug: 'accidentCategorySectionTOC',
  labels: { singular: 'Section TOC', plural: 'Section TOCs' },
  fields: [],
}

const AccidentCategoryRelatedGuides: Block = {
  slug: 'accidentCategoryRelatedGuides',
...
const AccidentCategoryTakeHome: Block = {
  slug: 'accidentCategoryTakeHome',
  labels: { singular: 'Take the Next Step', plural: 'Take the Next Step' },
  fields: [],
}

const AccidentCategoryHowWeKeepAccurate: Block = {
  slug: 'accidentCategoryHowWeKeepAccurate',
...
const AccidentCategorySources: Block = {
  slug: 'accidentCategorySources',
...
const AccidentCategoryExploreMore: Block = {
  slug: 'accidentCategoryExploreMore',
...
export const ACCIDENTCATEGORY_BLOCKS: Block[] = [
