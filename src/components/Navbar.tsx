    ...
    >
      <nav className="container mx-auto px-5 sm:px-6 lg:px-8 flex items-center justify-between h-16 lg:h-20">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center gap-2 group transition-opacity duration-300 hover:opacity-80">
            <span
        ...
        <div className="hidden md:flex items-center gap-3">
          <Button variant="gradient" asChild className="text-sm h-10 px-5 flex items-center gap-1.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105">
        ...
        <div className="md:hidden bg-[#030608]/95 backdrop-blur-xl border-t border-white/[0.08] absolute w-full max-h-[80vh] overflow-y-auto">
          <div className="container py-6 px-5 flex flex-col gap-4">
            ...
            <div className="pt-4 mt-2 border-t border-white/[0.08]">
              <Button variant="gradient" asChild className="w-full flex items-center justify-center gap-2 font-medium hover:scale-105 rounded-lg h-12">
