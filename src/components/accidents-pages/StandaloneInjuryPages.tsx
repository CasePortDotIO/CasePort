...
const DS_COMMON: [string, string, string][] = [
  ...
  [
    'Abdominal pain',
    'A red flag for internal injuries — seek care immediately.',
    'internal-injuries',
  ],
...
const DS_FAQS: Faq[] = [
  {
    q: 'Is it normal to feel pain days after a car accident?',
    a: 'Yes. It is medically normal to develop pain 24 to 72 hours after a crash. Adrenaline masks pain at the scene; as it wears off, inflammation builds and injuries like whiplash and soft-tissue damage become apparent.',
  },
  {
    q: 'How long after a car accident can symptoms appear?',
    a: 'Most delayed symptoms appear within 24 to 72 hours, but some — particularly nerve symptoms and psychological effects like PTSD — can emerge over days to weeks. Brain-injury and internal-bleeding symptoms can appear within hours and are emergencies.',
  },
  {
    q: 'Should I see a doctor if symptoms appear days later?',
    a: 'Yes. See a doctor promptly when delayed symptoms appear. It protects your health — some delays are dangerous — and it creates the medical record that connects your injury to the crash, which is essential to a claim.',
  },
  {
    q: 'Can I still file a claim if my symptoms were delayed?',
    a: 'Absolutely. Delayed symptoms are common and well-recognized. The key is to seek care as soon as symptoms appear and document everything, so the gap between the crash and your symptoms is explained by medical evidence.',
  },
]
  ...
  return (
    <>
      <HeroPhoto
        crumbs={
          <Breadcrumbs
            items={[{ label: 'Injuries', href: '/injuries' }, { label: 'Delayed Symptoms' }]}
          />
        }
      ...
      <KeyTakeaways
        items={[
          ...
          'Some delays are dangerous',
          'Gaps hurt your claim',
        ]}
      />
        ...
        <div className="container-4">
          ...
          <RecoveryViz
            phases={[
              {
                time: 'At the scene',
                phase: 'Adrenaline peak',
                desc: 'Pain is suppressed. Many people feel "fine" and decline care — a critical mistake.',
              },
              {
                time: '6–24 hours',
                phase: 'Onset',
                desc: 'As adrenaline fades, neck stiffness, headache, and soreness begin to appear.',
              },
              {
                time: '24–72 hours',
                phase: 'Peak symptoms',
                desc: 'Inflammation peaks. Whiplash, soft-tissue, and concussion symptoms are usually clear by now.',
              },
              {
                time: 'Days–weeks',
                phase: 'Evolving',
                desc: 'Nerve symptoms, mood changes, and deeper injuries can still emerge. Keep documenting.',
              },
            ]}
          />
        </div>
      ...
      <Sources
        medical
        citeTitle="Delayed Symptoms After a Car Accident — What to Watch For"
        citeUrl="/injuries/delayed-symptoms-after-car-accident"
      />
      <CTABand
        title="Symptoms Showing Up Now?"
        sub="See a doctor first. Then get a free, confidential case review to protect your rights — at no cost."
      ...
      <JsonLd
        data={[
          medicalWebPage({
            headline: 'Delayed Symptoms After a Car Accident',
            description: 'Why pain appears 24–72 hours after a crash, and what to do.',
          }),
          faqSchema(DS_FAQS),
          breadcrumb([
            ...
            { name: 'Delayed Symptoms', url: '/injuries/delayed-symptoms-after-car-accident' },
          ]),
...
const WD_FAQS: Faq[] = [
  {
    q: 'Should I see a doctor after a minor car accident?',
    a: 'Yes. Even after a minor crash, you should be evaluated promptly — ideally the same day. Adrenaline masks injuries, and conditions like whiplash and concussion often have delayed symptoms. A same-day record also protects a potential claim.',
  },
  {
    q: 'How long after an accident can I wait to see a doctor?',
    a: 'Don’t wait. Seek care the same day if possible, and immediately for any red-flag symptom. Beyond the health risk, gaps between the crash and treatment are the most common way insurers argue an injury wasn’t serious.',
  },
  {
    q: 'What are the warning signs I need emergency care?',
    a: 'Go to the ER for loss of consciousness or confusion, a worsening headache, chest or abdominal pain, numbness or weakness, difficulty breathing, or loss of bladder/bowel control. These can signal brain injury, internal bleeding, or spinal injury.',
  },
  {
    q: 'Why does seeing a doctor matter for my claim?',
    a: 'Medical records are the foundation of an injury claim. A prompt, consistent treatment record connects your injuries to the crash and documents their severity. Without it, insurers argue you weren’t really hurt.',
  },
]
  ...
  return (
    <>
      <HeroPhoto
        crumbs={
          <Breadcrumbs
            items={[{ label: 'Injuries', href: '/injuries' }, { label: 'When to See a Doctor' }]}
          />
        }
        eyebrow="After a crash · High intent"
      ...
      />
      <KeyTakeaways
        items={['Go the same day', 'ER for red flags', 'No gaps in care', 'Follow the full plan']}
      />
            ...
            phases={[
              {
                time: 'Same day',
                phase: 'Get evaluated',
                desc: 'See a doctor, urgent care, or the ER — even for a "minor" crash. This is the most important medical and legal step.',
              },
              {
                time: '24–72 hours',
                phase: 'Watch for delayed symptoms',
                desc: 'If new pain, headache, numbness, or mood changes appear, seek care again right away.',
              },
              {
                time: 'First 1–2 weeks',
                phase: 'Follow up',
                desc: 'Attend every recommended follow-up and start any prescribed treatment. Consistency matters.',
              },
              {
                time: 'Ongoing',
                phase: 'Complete your treatment',
                desc: 'Finish the full course of care. Gaps and early stops are used to argue you weren’t hurt.',
              },
            ]}
          />
        </div>
      ...
      <Sources
        medical
        citeTitle="When to See a Doctor After an Accident — Red Flags & Timeline"
        citeUrl="/injuries/when-to-see-doctor-after-accident"
      />
      <CTABand
        title="Already Seen a Doctor?"
        sub="Good. Now get a free, confidential case review to understand your rights and what your claim may be worth."
        btn="Get Free Case Review"
      />
      <ArticleOverlays />
      <JsonLd
        data={[
          medicalWebPage({
            headline: 'When to See a Doctor After an Accident',
            description: 'Red-flag symptoms and the post-crash care timeline.',
          }),
          faqSchema(WD_FAQS),
          breadcrumb([
            { name: 'Home', url: '/' },
            { name: 'Injuries', url: '/injuries' },
            { name: 'When to See a Doctor', url: '/injuries/when-to-see-doctor-after-accident' },
          ]),
