...
export function GuideGlossaryPage() {
  return (
    <>
      <section className="page-intro">
        <div className="container-4">
          ...
          <p className="section-sub" style={{ marginTop: '.9rem' }}>
            Every term you&rsquo;ll hear during a claim, defined in plain English — and linked to
      ...
      <Sources
        citeTitle="Personal Injury Glossary — Plain-English Definitions"
        citeUrl="/guide/glossary"
      />
          ...
          <div className="faq-stack">
            {f.groups.map((grp, gi) => (
              <div className="faq-group" key={gi}>
                <h2
                  className="section-h"
                  style={{ fontSize: 'clamp(1.4rem,2.6vw,1.8rem)', marginBottom: '1.25rem' }}
                >
                  {grp.title}
                </h2>
