    ...
    <header className="sticky top-0 z-50 border-b border-white/[0.08] bg-[#030608]/80 backdrop-blur-2xl transition-all duration-500">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-8 text-[13px] font-medium text-[#9CA3AF] lg:flex">
          <Link href="/for-law-firms" className="link-underline transition duration-200 hover:text-white">For Law Firms</Link>
          <Link href="/markets" className="link-underline transition duration-200 hover:text-white">Market</Link>
          <Link href="/insights" className="link-underline transition duration-200 hover:text-white">Insights</Link>
          <Link href="/intelligence" className="link-underline transition duration-200 hover:text-white">Intelligence</Link>
          <Link href="/injured" className="group flex items-center gap-1.5 transition duration-200 hover:text-white">
            Injured?
          ...
          <AnimatePresence mode="wait">
            {scrolled ? (
              ...
              >
                ...
                <Button variant="gradient" className="rounded-full px-5 py-2 text-[13px] font-semibold">
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="bg-[#0A0E14] border-white/[0.08] w-[85%] sm:max-w-sm">
            <SheetHeader>
            ...
            <nav className="flex flex-col gap-1 px-4 mt-4">
              ...
              <div className="mt-6 pt-6 border-t border-white/[0.08]">
                ...
                <Button variant="gradient" className="w-full rounded-full px-6 py-3.5 text-sm font-semibold text-white shadow-[0_0_24px_rgba(0,212,255,0.2)]" >
                  Request Private Access
                </Button>
              </div>
            </nav>
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_1fr] lg:gap-12">
          <motion.div variants={fadeUp} initial="hidden" animate="visible" className="flex flex-col items-center text-center">
            ...
            <h1 className="text-[2.25rem] sm:text-[2.75rem] lg:text-[3.25rem] xl:text-[3.75rem] font-bold leading-[0.95] tracking-[-0.04em]">
              Stop Buying Leads.
              <br />
              <span className="bg-gradient-to-r from-[#00B4D8] via-[#5BB6C9] to-[#7C5CFF] bg-clip-text text-transparent">Start Controlling</span>
              <br />
              Case Flow.
            </h1>
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
              <Button variant="gradient" className="relative overflow-hidden rounded-full px-7 py-3 text-[14px] font-semibold">
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-3 gap-1.5">
                    {["Search Intent", "Demand Capture", "Qualification", "Routing", "Recovery", "Retained Value"].map((step, i) => (
                      <div key={step} className="rounded-lg border border-white/[0.08] bg-white/[0.03] px-2.5 py-2">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-center gap-2.5">
          {["Market-Capped Access", "Review-First Onboarding", "Verified Standards", "Controlled Case Distribution"].map((item) => (
            <div key={item} className="rounded-full border border-white/[0.08] bg-white/[0.03] px-3.5 py-1.5">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-[1.75rem] sm:text-[2.25rem] lg:text-[2.75rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
            The Opportunity Is
            <span className="bg-gradient-to-r from-[#F59E0B] to-[#FCD34D] bg-clip-text text-transparent"> Massive</span>
          </h2>
      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center mb-10">
          ...
          <h2 className="text-[1.5rem] sm:text-[2rem] lg:text-[2.5rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
            ...
            <br />
            <span className="bg-gradient-to-r from-[#00B4D8] via-[#5BB6C9] to-[#7C5CFF] bg-clip-text text-transparent">to Controlled Acquisition</span>
          </h2>
        </motion.div>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-2">
          {realities.map((item, i) => (
            <motion.div key={item.title} variants={staggerItem} className={`card-hover rounded-2xl transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 border border-white/[0.08] bg-white/[0.03] p-6 ${i === 0 ? 'sm:row-span-1' : ''}`}>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1fr_1fr] lg:gap-14">
          <motion.div variants={slideInLeft} initial="hidden" animate={isInView ? "visible" : "hidden"}>
            ...
            <h2 className="text-[1.75rem] sm:text-[2.25rem] lg:text-[2.75rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
              Not a Lead List.
              <br />
              <span className="bg-gradient-to-r from-[#00B4D8] via-[#5BB6C9] to-[#7C5CFF] bg-clip-text text-transparent">A Case Acquisition Engine.</span>
            </h2>
            <p className="mt-4 text-[1.0625rem] text-[#B8C0CC] leading-[1.75]">
          ...
          <motion.div variants={slideInRight} initial="hidden" animate={isInView ? "visible" : "hidden"}>
            <div className="relative">
              ...
              <img src={SYSTEM_VIZ} alt="CasePort system architecture visualization" className="relative rounded-2xl border border-white/[0.08] w-full" />
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-5 lg:grid-cols-3">
          {pillars.map((pillar, i) => (
            <motion.div key={pillar.title} variants={staggerItem} className="card-hover relative rounded-2xl transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 border border-white/[0.08] bg-white/[0.03] p-7">
              {/* Step number */}
    ...
    <section ref={ref} className="py-14 sm:py-18 lg:py-22">
      <div className="mx-auto max-w-5xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {specs.map((spec) => (
            <motion.div key={spec.label} variants={staggerItem} className="rounded-xl border border-white/[0.08] bg-white/[0.03] px-5 py-4 flex items-start gap-4">
    ...
    <section ref={ref} id="how-it-works" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((step) => (
            <motion.div key={step.num} variants={staggerItem} className="card-hover relative rounded-2xl transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 border border-white/[0.08] bg-white/[0.03] p-6">
        ...
        >
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="text-center lg:text-right">
              <Button variant="gradient" className="inline-flex items-center gap-2.5 rounded-full px-7 py-3.5 text-[14px] font-semibold text-black transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_60px_rgba(245,158,11,0.3)]" >
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {trustSignals.map((signal) => (
            <motion.div key={signal.title} variants={staggerItem} className="card-hover rounded-2xl transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 border border-white/[0.08] bg-white/[0.03] p-6 transition duration-300 hover:border-cyan-400/10">
  ...
  return (
    <section ref={ref} className="py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"} className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-7 sm:p-9 text-center mb-6">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            <motion.div key={testimonial.name} variants={staggerItem} className="card-hover rounded-2xl transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 transition-all duration-500 ease-out hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-lg hover:-translate-y-1 border border-white/[0.08] bg-white/[0.03] p-6">
      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <Accordion type="single" collapsible className="space-y-2.5">
            {faqs.map((faq, i) => (
              <AccordionItem key={i} value={`faq-${i}`} className="rounded-2xl border border-white/[0.08] bg-white/[0.03] px-6 overflow-hidden data-[state=open]:border-cyan-400/10 data-[state=open]:bg-white/[0.03] transition-colors duration-300">
      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8 text-center">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          ...
          <h2 className="text-[1.75rem] sm:text-[2.25rem] lg:text-[2.75rem] font-semibold leading-[1.1] tracking-[-0.03em] text-white">
            ...
            <br />
            <span className="bg-gradient-to-r from-[#F59E0B] to-[#FCD34D] bg-clip-text text-transparent text-[2.25rem] sm:text-[3rem] lg:text-[3.5rem]">3 Firms Per Metro Area.</span>
          </h2>
