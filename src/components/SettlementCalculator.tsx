...
import { calculateSettlement, SettlementCalculation } from '@/lib/settlementCalculator'
...
export default function SettlementCalculator() {
            ...
            <div>
              ...
              <div className="space-y-3">
                {INJURY_TYPES.map((type) => (
                  <label
                    key={type.id}
                    className="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-[#4A9BA8] transition"
                  >
                    <input
                      type="radio"
                      name="injury-type"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                <strong>100% Confidential.</strong> Your information is protected by attorney-client privilege
                and will never be shared without your consent.
              </p>
            </div>
          </div>
        )
  ...
  const getSocialProofData = () => {
    const socialProofStats: Record<string, { avgSettlement: string; settlementRate: string; avgTimeToSettle: string; successRate: string }> = {
      'car-accident': { avgSettlement: '$125,000', settlementRate: '92%', avgTimeToSettle: '14 months', successRate: '87%' },
      'truck-accident': { avgSettlement: '$285,000', settlementRate: '94%', avgTimeToSettle: '18 months', successRate: '91%' },
      'slip-fall': { avgSettlement: '$95,000', settlementRate: '88%', avgTimeToSettle: '12 months', successRate: '84%' },
      'medical-malpractice': { avgSettlement: '$450,000', settlementRate: '78%', avgTimeToSettle: '24 months', successRate: '82%' },
      'workplace-injury': { avgSettlement: '$165,000', settlementRate: '89%', avgTimeToSettle: '16 months', successRate: '86%' },
    }
    return socialProofStats[injuryType] || socialProofStats['car-accident']
  }
      ...
      <div className="bg-white rounded-lg p-8 border border-gray-200">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800">
                Statute of limitations for {state}: <strong>{calculation.statueOfLimitationsYears} years</strong> from
                date of injury.
              </p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-slate-50 to-slate-100 border border-slate-200 rounded-lg p-6 mb-8">
          <div className="flex gap-3 mb-4">
            <Shield className="w-5 h-5 text-[#4A9BA8] shrink-0 mt-0.5" />
            <div>
        ...
        <div className="bg-[#1F4D5C] text-white rounded-lg p-6 text-center">
          <p className="mb-4 font-semibold">Get Connected with a Top-Rated Attorney</p>
          <p className="text-sm mb-4 opacity-90">
            An experienced attorney will review your case and contact you within 24 hours.
          </p>
          <a
            href="/case-review"
            className="block w-full bg-[#C4714A] hover:bg-[#b85d38] text-white font-semibold py-3 rounded-lg transition"
          >
