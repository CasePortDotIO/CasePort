    ...
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#030608]/80 backdrop-blur-2xl transition-all duration-500">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-8 text-[13px] font-medium text-[#9CA3AF] lg:flex">
          ...
          <a href="#market" className="link-underline transition duration-200 hover:text-white">Market</a>
          ...
          <AnimatePresence mode="wait">
            {scrolled ? (
              ...
              >
                ...
                <button
                  className="rounded-full px-5 py-2 text-[13px] font-semibold text-white shadow-[0_0_24px_rgba(0,212,255,0.2)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_32px_rgba(0,212,255,0.35)]"
          ...
          <SheetContent side="right" className="bg-[#0A0E14] border-white/[0.06] w-[85%] sm:max-w-sm">
            ...
            <nav className="flex flex-col gap-1 px-4 mt-4">
              ...
              <div className="mt-6 pt-6 border-t border-white/[0.06]">
                ...
                <button className="w-full rounded-full px-6 py-3.5 text-sm font-semibold text-white shadow-[0_0_24px_rgba(0,212,255,0.2)]" style={{ background: "linear-gradient(135deg, #00B4D8 0%, #5BB6C9 40%, #7C5CFF 100%)" }}>
                  Request Private Access
                </button>
              </div>
            </nav>
...
function HeroSection() {
  return (
    <section id="hero" aria-label="CasePort Case Acquisition System" className="relative min-h-[85vh] flex items-center justify-center py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 w-full">
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_1fr] lg:gap-12">
          <motion.div variants={fadeUp} initial="hidden" animate="visible" className="flex flex-col items-center text-center">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
              <button
                className="relative overflow-hidden rounded-full px-7 py-3 text-[14px] font-semibold text-white shadow-[0_0_30px_rgba(0,212,255,0.25)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(0,212,255,0.4)]"
                style={{ background: "linear-gradient(135deg, #00B4D8 0%, #5BB6C9 40%, #7C5CFF 100%)" }}
              >
      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8 text-center">
        <motion.div variants={fadeUp} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          ...
          <div className="mt-7 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <button
              className="rounded-full px-8 py-3.5 text-sm font-semibold text-white shadow-[0_0_40px_rgba(0,212,255,0.3)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_50px_rgba(0,212,255,0.4)]"
              style={{ background: "linear-gradient(135deg, #00B4D8 0%, #5BB6C9 40%, #7C5CFF 100%)" }}
            >
              Request Private Access
            </button>
