...
import { Search, ArrowRight, ChevronDown, MapPin, Shield, Zap, BarChart3, Users, DollarSign, TrendingUp } from "lucide-react";
...
// Asset URLs
const HERO_BG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663482465617/ktqQZjYN63yrcvMQnNsZFC/market-hero-bg-9D6GHSkpdLkkozuSm2unqA.webp";
const GRID_TEXTURE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663482465617/ktqQZjYN63yrcvMQnNsZFC/market-grid-texture-7eZPAFga42ojCuB7JWGgHp.webp";
const DATA_VIZ = "https://d2xsxph8kpxj0f.cloudfront.net/310519663482465617/ktqQZjYN63yrcvMQnNsZFC/market-data-viz-UbhsTxdHdNbcpuYx3ymKkL.webp";
...
export default function MarketPage() {
  ...
  const filteredMarkets = useMemo(() => {
    return markets.filter((m) => {
      ...
      const matchesStatus = selectedStatus === "all" || m.status === (selectedStatus as MarketStatus);
  ...
  const sortedMarkets = useMemo(() => {
    const statusOrder: Record<MarketStatus, number> = { limited: 0, active: 1, capped: 2, evaluation: 3 };
  ...
  const handleUnlistedMarketSubmit = (data: { name: string; email: string; market: string; phone: string }) => {
  ...
  const orgSchema = {
    ...
    description: "CasePort is the infrastructure for case acquisition. Exclusive personal injury lead markets with territorial control.",
  ...
  const serviceSchema = {
    ...
    description: "Exclusive personal injury case acquisition infrastructure across 46 metro areas in the United States.",
  ...
  const webPageSchema = {
    ...
    description: "Browse 46 exclusive personal injury lead markets. Each market capped at 3 firms. Check availability in your territory.",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Markets", item: "https://www.caseport.io/markets" },
    ],
  };
  ...
  return (
    <>
      ...
      <main>
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-10 sm:pt-14 pb-12">
            ...
            <motion.div
              ...
              className="glass-panel inline-flex items-center gap-3 sm:gap-5 px-4 sm:px-5 py-2.5 mb-8 overflow-hidden"
              role="status"
            ...
            >
              ...
              <span className="system-label text-[#22D3EE] relative" style={{ fontSize: "11px" }}>System Status</span>
              <div className="h-4 w-px bg-white/[0.1]" />
              <div className="flex items-center gap-1.5 relative">
                <span className="w-1.5 h-1.5 rounded-full bg-[#10B981] animate-breathe" />
                <span className="text-[12px] text-[#B0B8C4]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{
                      background: "linear-gradient(90deg, #00B4D8 0%, #5BB6C9 40%, #7C5CFF 100%)",
                      backgroundClip: "text",
                ...
                <p className="text-[15px] text-[#B0B8C4] mb-10 leading-relaxed max-w-[520px]">
                  Every metro area in the CasePort network is capped at three partner firms. Not artificial scarcity — a structural requirement. The math is simple: 46 markets, 3 firms each, and the strongest firms fill first.
                </p>
                <button
              ...
              >
                {[
                  ...
                  >
                    <span className="system-label text-[#6B7280] block mb-2" style={{ fontSize: "10px" }}>
                      {stat.label}
                    </span>
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                <div>
                  ...
                  <p className="text-[16px] text-[#B0B8C4] max-w-[500px]">
                    Search by city, state, or region. If your market is not listed, request priority evaluation.
                  </p>
                </div>

                {/* Legend */}
                <div className="flex flex-wrap items-center gap-5" role="legend" aria-label="Market status legend">
                  {[
            ...
            {noResults ? (
              <div className="text-center py-20">
                <p className="text-[18px] text-[#B0B8C4] mb-6">No markets found for "{searchQuery}".</p>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {sortedMarkets.map((market, idx) => (
                  <MarketCard key={market.id} market={market} index={idx} onSelect={setSelectedMarket} />
                ))}
              </div>
            )}
          </div>
        ...
        {/* ============================================ */}
        <section className="relative py-20 sm:py-28" style={{ backgroundColor: "oklch(0.06 0.01 250)" }}>
          <div className="container max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-[16px] text-[#B0B8C4] max-w-[640px] mx-auto">
                The difference between a firm that signs 15 cases a month and one that signs 50 is rarely about marketing spend. It is about territorial control over high-intent demand before it reaches the open market.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "When five firms compete for the same lead, conversion rates collapse to single digits. The 3-firm cap ensures your investment in case acquisition actually compounds.",
                  stat: "3",
                ...
                },
                {
                  ...
                  description: "Each market has dedicated demand capture infrastructure. Your territory is not shared with a rotating list of buyers. It is architecturally separated.",
                  stat: "100%",
                ...
                },
                {
                  ...
                  description: "Every interaction in your market feeds a proprietary data layer. The longer you operate within the system, the more precise your case flow becomes.",
                  stat: "MII",
                ...
                >
                  <div className="w-10 h-10 rounded-[10px] flex items-center justify-center mb-5" style={{ background: "rgba(34,211,238,0.08)", color: "#22D3EE" }}>
                    {item.icon}
                  </div>
                  <h3 className="text-[18px] font-bold text-white mb-2">{item.title}</h3>
                  <p className="text-[15px] text-[#B0B8C4] leading-relaxed mb-5">{item.description}</p>
                  <div className="pt-4 border-t border-white/[0.06]">
                    <span className="text-[24px] font-bold" style={{ color: "oklch(0.78 0.13 195)" }}>
                      {item.stat}
                    </span>
                    <span className="system-label text-[#6B7280] block mt-1" style={{ fontSize: "11px" }}>
                      {item.statLabel}
                    </span>
                  </div>
                </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <p className="text-[16px] text-[#B0B8C4] mb-6 leading-relaxed">
                  Every CasePort market is architecturally limited to exactly 3 partner firms. This is not artificial scarcity created by marketing. It is a structural requirement.
                </p>
                <p className="text-[16px] text-[#B0B8C4] mb-6 leading-relaxed">
                  When a market reaches capacity, new applicants join a waitlist. When a partner leaves, the next firm on the waitlist is activated. The system maintains its integrity.
                </p>
                <div className="space-y-4">
                  {[
                    { step: 1, label: "Market Opens", desc: "Infrastructure deployed, 0 of 3 slots filled" },
                    { step: 2, label: "Firms Activate", desc: "Partners onboarded, slots fill to capacity" },
                    { step: 3, label: "Market Capped", desc: "3 of 3 slots filled, new firms waitlisted" },
                    { step: 4, label: "Waitlist Activated", desc: "When a partner leaves, next firm activated" },
                  ].map((item) => (
              ...
              >
                <img src={DATA_VIZ} alt="Market capacity visualization" className="w-full rounded-[8px]" />
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-20 sm:py-28" style={{ backgroundColor: "oklch(0.06 0.01 250)" }}>
          <div className="container max-w-5xl">
            <div className="text-center mb-16">
              ...
              <p className="text-[16px] text-[#B0B8C4] max-w-[640px] mx-auto">
                MII is a proprietary scoring system that combines search intent, competition density, settlement values, and population growth. Higher scores = better markets.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              {[
                { label: "Search Intent", desc: "Monthly PI-related search volume in the metro area", icon: TrendingUp },
                { label: "Competition Density", desc: "Number of active PI firms competing for leads", icon: Users },
                { label: "Settlement Values", desc: "Average case settlement range for the market", icon: DollarSign },
                { label: "Population Growth", desc: "YoY population growth trajectory", icon: BarChart3 },
              ].map((item, idx) => (
                <motion.div
                  key={item.label}
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-[8px] flex items-center justify-center flex-shrink-0" style={{ background: "rgba(34,211,238,0.15)", color: "#22D3EE" }}>
                      <item.icon size={18} />
                    </div>
                    <div>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <div className="px-6 pb-4 text-[14px] text-[#B0B8C4] leading-relaxed border-t border-white/[0.06] pt-4">
                    {item.a}
                  </div>
                </motion.details>
              ))}
          ...
          <div className="container max-w-3xl text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-[16px] text-[#B0B8C4] mb-10 max-w-[600px] mx-auto leading-relaxed">
                5 markets are already at capacity. 8 more have only one slot remaining. The math is simple: 46 markets, 3 firms each, and the strongest firms fill first.
              </p>
              ...
              <p className="text-[12px] text-[#6B7280] mt-8" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
        ...
        {hasUnlistedMarket && <UnlistedMarketForm searchQuery={searchQuery} onSubmit={handleUnlistedMarketSubmit} />}
        ...
        {/* Exit-Intent Modal */}
        <ExitIntentModal isOpen={showExitIntent} onClose={() => setShowExitIntent(false)} onSubmit={handleExitIntentSubmit} />
