...
import { X, ArrowRight, TrendingUp, Users, Search, DollarSign } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="px-6 py-8">
          {/* Market Name */}
          <div className="mb-8">
            <h2 className="text-[32px] font-bold text-[#F1F3F5] leading-tight mb-1" style={{ letterSpacing: "-1.2px" }}>
              {market.metro}
            </h2>
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              >
                <span className="w-2 h-2 rounded-full animate-breathe" style={{ backgroundColor: color }} />
                {statusLabels[market.status]}
              </span>
              <span className="text-[12px] text-[#6B7280]">{statusDescriptions[market.status]}</span>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 mb-6">
            ...
            <div className="flex items-end gap-3">
              <span className="text-[56px] font-bold text-[#F1F3F5] leading-none" style={{ letterSpacing: "-2px" }}>
                {market.mii}
              </span>
            ...
            <p className="text-[11px] text-[#6B7280] mt-3">
              Composite score based on search intent volume, competition density, average case value, and market growth trajectory.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="glass-panel p-4">
              ...
              <span className="text-[16px] font-bold text-[#F1F3F5]">
                {market.avgCaseValue}
              </span>
            </div>
            <div className="glass-panel p-4">
          ...
          <div className="glass-panel p-5 mb-6">
              ...
              {Array.from({ length: market.maxPartners }).map((_, i) => (
                <div key={i} className="flex-1">
                  <div
                    ...
                    style={{
                      fontFamily: "'JetBrains Mono', monospace",
                      backgroundColor: i < market.partnersActive ? `${color}20` : "rgba(255,255,255,0.03)",
            ...
            {!isCapped && (
              <p className="text-[12px] text-[#B0B8C4] mt-3">
                {slotsRemaining} partner {slotsRemaining === 1 ? "slot" : "slots"} remaining in this metro area.
              </p>
            )}
            {isCapped && (
              <p className="text-[12px] text-[#6B7280] mt-3">
                This market has reached capacity. Join the waitlist to be notified when a slot opens.
              </p>
            )}
          </div>
          ...
          <a
            href={ctaHref}
            className="cta-primary w-full text-[14px] mb-3"
          >
            {ctaText}
            <ArrowRight size={16} />
          </a>
          ...
          {isCapped && (
            <p className="text-[11px] text-[#6B7280] text-center" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
